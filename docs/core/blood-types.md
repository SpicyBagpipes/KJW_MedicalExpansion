...
As with the real world, units in ME:C have blood types. Type rejection is able to be disabled. By default, blood bags taken from the arsenal have the "ideal"  statistics; they have no chance of rejection from the recipient's body, and have 100% Red Blood Cell, White Blood Cell and Platelet counts, along with having no diseases carried.
