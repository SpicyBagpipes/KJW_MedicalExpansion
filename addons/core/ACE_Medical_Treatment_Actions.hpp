class ACE_Medical_Treatment_Actions {
	...
	class RemoveIV: ApplyIV {
		...
		callbackSuccess = QFUNC(removeIV);
	};
	class PushIV: ApplyIV {
		...
		callbackSuccess = QFUNC(pushIV);
		callbackStart = QFUNC(showBloodLabel);
	};
	class Transfusion_500: ApplyIV {
		...
		callbackSuccess = QFUNC(drawBlood);
	};
