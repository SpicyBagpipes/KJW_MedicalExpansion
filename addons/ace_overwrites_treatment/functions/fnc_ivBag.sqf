...
params ["_medic", "_patient", "_bodyPart", "_classname", "_itemUser", "_usedItem", "_selectedFluid"];
...
[QGVAR(ivBagLocal), [_patient, _bodyPart, _classname, _medic, _itemUser, _usedItem, _selectedFluid], _patient] call CBA_fnc_targetEvent;